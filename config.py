...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7926099572:AAGWcHlnUW43NkDLL6d3SjRHMQFvXzhMbQg")

#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "20901045"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "dec03cafafbd892b285499762a896082")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002233160226"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6324457826"))
...
TUT_VID = os.environ.get("TUT_VID","hhsoccso8853")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6324457826").split()):
        ADMINS.append(int(x))
except ValueError:
